...
int MAGIC_Classification( TString myMethodList = "" )
{
   ...
   //MAGIC variables: fLength,fWidth,fSize,fConc,fConc1,fAsym,fM3Long,fM3Trans,fAlpha,fDist;
  ...
  // dataloader->SetBackgroundWeightExpression( "weight" );
   ...
   //MAGIC Data Set :
   //g = gamma (signal): 12332 --> 50% = 6166, 70% = 8632
   // h = hadron (background): 6688 --> 50% = 3344, 70% = 4681
...
int main( int argc, char** argv )
{
   ...
   return MAGIC_Classification(methodList);
}
